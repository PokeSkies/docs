---
title: FAQs
description: Frequently asked questions about the SkiesShop mod
---

Due to the potential complexity of this mod, there are some frequent issues and questions that may arise when using SkiesShop. Below are some of the most common questions and their answers:

### Player Heads
**Q:** How do I set a player head as an item in my GUI?

**A:** Player Heads can be set using the special keyword `playerhead` followed by an option specifier. See the [Player Heads](/skiesshop/shop_config/items/#player-heads) section in Supported Materials for more information on available playerhead item specifiers.
