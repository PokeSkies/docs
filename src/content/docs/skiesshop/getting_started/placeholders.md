---
title: Placeholders
description: Supported Placeholder API services for SkiesShop
---

SkiesShop supports the use of Placeholder APIs to allow for dynamic text within the configurations, such as player names, balances, and other placeholders. Most string inputs throughout the mod will be parsed for placeholders, including item names, lore, titles, and more.
